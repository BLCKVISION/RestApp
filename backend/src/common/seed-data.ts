...
export const SEED_SOLICITUDES: ISolicitudComida[] = [
  ...
  {
    id: 'sol00000-0000-0000-0000-000000000006',
    centroId: 'c1a00000-0000-0000-0000-000000000002',
    cantidadSolicitada: 200,
    tipoComidaId: 'tc000000-0000-0000-0000-000000000001',
    horaEntrega: '11:00 AM',
    responsable: 'Comedor La Paz (Pedro)',
    estado: EstadoSolicitud.PENDIENTE,
    fechaSolicitada: today(),
    createdAt: today(),
  },
  {
    id: 'sol00000-0000-0000-0000-000000000007',
    centroId: 'c1a00000-0000-0000-0000-000000000001',
    cantidadSolicitada: 60,
    tipoComidaId: 'tc000000-0000-0000-0000-000000000002',
    horaEntrega: '02:00 PM',
    responsable: 'Fundación Niños Felices',
    estado: EstadoSolicitud.APROBADA,
    fechaSolicitada: today(),
    createdAt: today(),
  },
  {
    id: 'sol00000-0000-0000-0000-000000000008',
    centroId: 'c1a00000-0000-0000-0000-000000000002',
    cantidadSolicitada: 150,
    tipoComidaId: 'tc000000-0000-0000-0000-000000000001',
    horaEntrega: '12:30 PM',
    responsable: 'Asilo San Juan',
    estado: EstadoSolicitud.PENDIENTE,
    fechaSolicitada: today(),
    createdAt: today(),
  }
